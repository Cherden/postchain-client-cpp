...
std::string ToHexString(const std::vector<unsigned char>& bytes) {
    ...
    boost::algorithm::hex(bytes.begin(), bytes.end(), std::back_inserter(hex_string));
    return hex_string;
}
...
TEST(ASN1Writer, BRIDOctetStringTest) {
    asn1::Writer writer;
    auto brid = PostchainUtil::HexStringToByteVector("E2BE5C617CE50AFD0882A753C6FDA9C4D925EEDAC50DB97E33F457826A856DE0");
    writer.WriteOctetString({brid.begin(), brid.end()});
    
    std::string expected_hex = "0420E2BE5C617CE50AFD0882A753C6FDA9C4D925EEDAC50DB97E33F457826A856DE0";
    EXPECT_EQ(expected_hex, ToHexString( writer.Encode()));
}
...
TEST(ASN1Writer, SpecialCharactersUTF8StringTest) {
    ...
    std::string expected_hex = "";
    EXPECT_EQ(expected_hex, ToHexString(writer.Encode()));
}
...
TEST(ASN1Writer, SequenceTest) {
    ...
    std::string expected_hex = "304730220420E2BE5C617CE50AFD0882A753C6FDA9C4D925EEDAC50DB97E33F457826A856DE0302130130C08746573745F6F70310C046172673102012A300A0C08746573745F6F7032";
    EXPECT_EQ(expected_hex, ToHexString(writer.Encode()));
}
